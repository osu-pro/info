...
const epidemy = [
    ...
    {user: "377126876524838914", from: "278168905648701440"}, // Спейс стримы
    {user: "311368723946799104", from: "381106633964650497"}, // Solanbuy
    {user: "778535398946242581", from: "1247672972693471408"} // kyosuke^<3
]
